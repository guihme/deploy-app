...
let SchedulingRepository = class SchedulingRepository {
    ...
    async save(data) {
        try {
            await this.repository.save(entity_1.ORMScheduling.import(data));
    ...
    async all() {
        ...
        const schedulesEntity = [];
        for (const scheduleORM of schedulesORM) {
            const scheduleEntity = scheduleORM.export();
            schedulesEntity.push(scheduleEntity);
        }
        return result_1.Result.ok(schedulesEntity);
    }
};
SchedulingRepository = __decorate([
    (0, common_1.Injectable)(),
    __param(0, (0, typeorm_1.InjectRepository)(entity_1.ORMScheduling)),
    __metadata("design:paramtypes", [typeorm_2.Repository])
], SchedulingRepository);
exports.SchedulingRepository = SchedulingRepository;
//# sourceMappingURL=SchedulingRepository.js.map